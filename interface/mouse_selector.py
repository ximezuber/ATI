...
class Application(tk.Frame):
    ...
    def __init__(self, img, parent, *args, **kwargs):
        ...
        self.position_tracker = MousePositionTracker(self.canvas)
        self.position_tracker.autodraw(command=on_drag)  # Enable callbacks.
